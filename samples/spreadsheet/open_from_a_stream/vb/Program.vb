...
Module Program
    Sub Main(args As String())
        ...
        ' <Snippet2>
        Using fileStream As FileStream = New FileStream(args(0), FileMode.OpenOrCreate, FileAccess.ReadWrite)
    ...
    Public Sub OpenAndAddToSpreadsheetStream(ByVal stream As Stream)
        ...
        Using mySpreadsheetDocument As SpreadsheetDocument = SpreadsheetDocument.Open(stream, True)
