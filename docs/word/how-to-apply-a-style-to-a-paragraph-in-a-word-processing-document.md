...
represented by the [ParagraphProperties](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.paragraphproperties) class. The code
determines if the element exists, and creates a new instance of the
**ParagraphProperties** class if it does not.
The **pPr** element is a child of the **p** (paragraph) element; consequently, the [PrependChild\<T\>(T)](https://learn.microsoft.com/dotnet/api/documentformat.openxml.openxmlelement.prependchild) method is used to add
...
element is represented by the [Styles](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.styles) class in the Open XML SDK. Finally,
...
method, the work begins with retrieving the **Styles** element through the **Styles** property of the [StyleDefinitionsPart](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.maindocumentpart.styledefinitionspart) of the main document
...
such as the [Type](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.style.type) of style (paragraph) and [StyleId](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.style.styleid). As mentioned above, the styleid is
...
appropriate child elements, the code creates an instance of the [StyleRunProperties](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.stylerunproperties) class and then appends
...
code creates an instance of the [ParagraphStyleId](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.paragraphstyleid) class with the styleid and
