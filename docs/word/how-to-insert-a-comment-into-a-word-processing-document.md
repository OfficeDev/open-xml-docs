...
using the [Open(String, Boolean)](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.wordprocessingdocument.open) method, with the
...
that are of type [Paragraph](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.paragraph). The **First** method is a member
of the
...
[System.Collections.Generic.IEnumerable](https://learn.microsoft.com/dotnet/api/system.collections.generic.ienumerable-1)
interface.
...
The code first determines whether a [WordprocessingCommentsPart](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.wordprocessingcommentspart) part exists. To
do this, call the [MainDocumentPart](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.maindocumentpart) generic method, **GetPartsCountOfType**, and specify a kind of **WordprocessingCommentsPart**.

If a **WordprocessingCommentsPart** part
exists, the code obtains a new **Id** value for
the [Comment](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.comment) object that it will add to the
existing **WordprocessingCommentsPart** [Comments](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.comments) collection object. It does this by
...
creates one using the [AddNewPart\<T\>()](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.openxmlpartcontainer.addnewpart) method of the [MainDocumentPart](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.maindocumentpart) object and then adds a
...
the Wordprocessing document. [CommentRangeStart](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.commentrangestart) and [CommentRangeEnd](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.commentrangeend) objects correspond to the
**commentRangeStart** and **commentRangeEnd** elements in the Open XML
Wordprocessing schema. A **CommentRangeStart**
object is given as the argument to the [InsertBefore\<T\>(T, OpenXmlElement)](https://learn.microsoft.com/dotnet/api/documentformat.openxml.openxmlcompositeelement.insertbefore) method
of the [Paragraph](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.paragraph) object and a **CommentRangeEnd** object is passed to the [InsertAfter\<T\>(T, OpenXmlElement)](https://learn.microsoft.com/dotnet/api/documentformat.openxml.openxmlcompositeelement.insertafter) method.
...
A [CommentReference](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.commentreference) object represents a
...
specifying the **Id** value, and then adds it to a [Run](https://learn.microsoft.com/dotnet/api/documentformat.openxml.wordprocessing.run) object.
