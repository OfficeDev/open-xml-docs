...
different signature. The sample code in this topic uses the [Open(String, Boolean)](https://learn.microsoft.com/dotnet/api/documentformat.openxml.packaging.wordprocessingdocument.open) method with a
